...
SRC_URI += "file://0001-Fixed-build-issue-by-upgrading-to-C-23.patch \
            file://0002-Changed-the-path-of-the-service-file-to-folow-the-re.patch \
           "
...
RDEPENDS:${PN}:append = "amd-apml"

FILES:${PN}:append = "${systemd_system_unitdir}/xyz.openbmc_project.Control.Host.Power_cap.service"
